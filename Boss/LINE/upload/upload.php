...
echo '<div class="element-input"><label class="title">網址</label><button onclick="copyFunction()">Copy text</button><input class="large" type="text" name="myInput" value="'.$img.'" id="myInput" /></div>

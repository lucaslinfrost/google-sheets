...
$code = explode("#", $value);
$forbidcode1 = array("老大", "幹", "機掰", "雞掰", "洨", "姦", "中出", "內射", "奶子", "三小", "尛", "雞雞", "老二", "陰莖", "吹屌", "口交", "顏射", "賤", "智障", "白癡", "白吃", "下三濫", "腦殘", "吃屌", "戇鳩", "on9", "性交", "做愛", "插入", "陰道", "陰唇", "下面癢", "下麵給你吃", "下面給你吃", "你就爛", "你娘", "去你妹", "去死", "白帶", "精液", "精子", "破處", "一夜情", "約炮", "約泡", "打泡", "打炮", "靠腰", "靠妖", "靠么");

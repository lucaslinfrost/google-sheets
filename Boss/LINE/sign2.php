...
switch ($event['type']) {       
    case 'message':
        ...
        if (strpos($code[1], '白羊') !== false||
            strpos($code[1], '牡羊') != false||
            strpos($code[1], '牧羊') != false){$snum = '0';}
        if (strpos($code[1], '金牛') !== false||
            strpos($code[1], '牡牛') != false||
            strpos($code[1], '牧牛') != false){$snum = '1';}
        ...
        if (strpos($code[1], '天秤') !== false||
            strpos($code[1], '天平') != false){$snum = '6';}
        if (strpos($code[1], '天蠍') !== false){$snum = '7';}
        if (strpos($code[1], '射手') !== false){$snum = '8';}
        if (strpos($code[1], '魔羯') !== false||
            strpos($code[1], '山羊') != false||
            strpos($code[1], '摩羯') != false){$snum = '9';}
        if (strpos($code[1], '水瓶') !== false||
            strpos($code[1], '寶瓶') != false){$snum = '10';}

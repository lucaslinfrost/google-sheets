...
function create($inputStr,$userName){
	...
	$bg = '{
    "A" :["結實","英俊","粗鄙","機靈","迷人","娃娃臉","聰明","蓬頭垢面","愚鈍","骯髒","耀眼","有書卷氣","青春洋溢","感覺疲憊","豐滿","粗壯","毛髮茂盛","苗條","優雅的","邋遢的","敦實","蒼白","陰沉","平庸","臉色紅潤","皮膚黝黑","滿臉皺紋","古板","有狐臭","狡猾","健壯","嬌俏","筋肉發達","魁梧","遲鈍","虛弱","小屁孩","佛系","美麗","奇怪","猥瑣","暴力","愛幻想","少女情懷","搞笑","傻傻","萌萌的","邊緣","腹黑","無所事事","喪心病狂"],    
    "B" :["冒險家","見習戰士","見習魔法師","戰士","魔法師","見習騎士","見習獵人","騎士","獵人","見習巫師","見習祭司","巫師","祭司","見習聖騎士","聖騎士","見習劍鬥士","劍鬥士","見習百獸騎士","百獸騎士","見習狙擊手","狙擊手","見習刺客","刺客","見習招喚師","招喚師","見習賢者","賢者","見習主教","主教","見習幻術師","幻術師","見習武鬥家","武鬥家","見習死靈法師","死靈法師","見習隨侍","隨侍","忍者","武士","吟遊詩人","鍊金術師"],
    "C" :["奇基姆","科隆","阿姨","大叔","老奶奶","老爺爺","上宮","色石","王石","爆裂魔法","工口漫畫","幼女","蘿莉","正太","男性","女性","廁所","魔王","勇士","國王","天神","禁咒","黑夜","光明","正義","邪惡","光明","黑暗","燃火","烈焰","熔炎","靜水","激流","巨濤","大地","巨岩","樹海","微風","暴風","狂風","中二病","小屁孩","巨乳","大屁屁","裝備","時裝","劍","弓","爪","投擲","杖","萬劍","狙擊槍","鐮刀","飛鏢","法杖","薩羅","襪子","胖次"],
    "D" :["追求者","蒐集者","吟唱者","討伐者","殲滅者","制裁者","暗戀者","愛慕者","玩弄者","幻想者","統治者","奴役者","使用者","認可者","信賴者","發明者","脫衣者","玷汙者","勇者","狩獵者","掃除者","爆裂者","撫摸者","至上主義者","操縱者","招喚者","擁有者","鄙視者","破壞者","唾棄者","遺棄者","不忠者","謀略者","開發者","閱讀者","視察者","凝視者","觸摸者","行動者","警告者","封印者","闖入者","撼動者","擁抱者","掠奪者","發現者","保護者"],
    "E" :["偷奶奶的內衣","偷窺鄰居","從王的屍體挖寶","說黃色笑話","從背後偷偷的來一下","歇斯底里的狂吼","裝可愛喵喵叫","找到走失的大叔","將腋毛中分","劇烈的抖動身體某個部位","沒有任何擅長的事","將鼻屎瞄的很準","一邊吃飯一邊上廁所","幫人剪成麥當勞叔叔的髮型","性騷擾肥胖的中年大叔","放置Play"],    
    "F" :["甜食","狗","貓","咖啡","胖次","吊飾","拳擊手套","鋒利的菜刀","兔子","幼女","樂器","貧乳","書本","高檔貨","色色的睡衣","光頭"],    
    "G" :["慷慨大方的人","對動物很友善的人","善於夢想的人","享樂主義者","甘冒風險的賭徒或冒險者", "善於料理的人", "萬人迷","忠心耿耿的人","有好名聲的人","充滿野心的人"]
...
【喜歡】".$bg["A"][Dice(count($bg["A"]))-1]."的".$bg["F"][Dice(count($bg["F"]))-1]."。

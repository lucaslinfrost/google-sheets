...
function parseInput ($inputStr){
	...
	}else if(preg_match ("/creat/i", $inputStr)){
		return creat();
...
function creat(){
    ...
    "SP" :["奇基姆","科隆","阿姨","大叔","老奶奶","老爺爺","上宮","色石","王石","爆裂魔法","工口漫畫","蘿莉","正太","男性","女性","廁所","魔王","勇者","國王","天神","禁咒","黑夜","光明","正義","邪惡","光明","黑暗","燃火","烈焰","熔炎","靜水","激流","巨濤","大地","巨岩","樹海","微風","暴風","狂風","中二病","小屁孩","巨乳","大屁屁","裝備","時裝","劍","弓","爪","投擲","杖","萬劍","狙擊槍","鐮刀","飛鏢","法杖","薩羅","襪子","胖次"],
